...
$ecms_config['esafe']['ecookiernd']='L2EtWcCXRvdD5Gc1bYUYwzh9caskZIRrsZWy';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='fgsob';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='ryidm';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='iBMJmMpW4486z5gCwEjJUME6TPOhduMMg8S';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='yMBtRmSlKdFZpa5YRNVIjFHAwimFTvTFKF';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='qPLekk7WYj9WrcwavxnYOMV7ftlkEP44q';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='wFP3xUFNCusOgx3ZDqyTLOkILLSL0c2g';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='53BCY3SDcMQcyDvmChyLzbTc7He73l2';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'newsurl'=>'/',
'filetype'=>'|.svg|.gif|.jpg|.jpeg|.swf|.rar|.zip|.mp3|.wmv|.txt|.doc|.png|',
'filesize'=>2048,
'relistnum'=>8,
'renewsnum'=>100,
'min_keyboard'=>2,
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'zdD5NYUW9ZBCjhBVlEfTuv6XjtjiLYPZ',
...
'openfileserver'=>0,
'fs_purl'=>'',
'closemods'=>',down,movie,shop,pay,rss,search,sch,error,member,pl,print,mconnect,fieldand,gb,fb,mlist,',
'fieldandtop'=>0,
'fieldandclosetb'=>'',
'filedatatbs'=>',1,',
'filedeftb'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'B1ddTycOYKQeL6p9Br6LYnvGSKPRAuwH661i',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'fUtywBvGayR53ux0JjPKqGQk3h1keefIihYfUMBBWC',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
